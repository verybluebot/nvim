...
vim.o.autoread = true -- Reload files changed outside Neovim when safe (default: false)
...
-- Keep buffers fresh when files are changed externally, e.g. by Pi.
...
vim.api.nvim_create_autocmd('FileChangedShellPost', {
  group = vim.api.nvim_create_augroup('external-file-refresh-notify', { clear = true }),
  callback = function()
